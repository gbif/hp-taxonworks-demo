...
[![Build Status](https://builds.gbif.org/job/hp-taxonworks-demo/badge/icon)](https://builds.gbif.org/job/hp-taxonworks-demo/lastBuild/console)
...
# GBIF Hosted Portal: taxonworks-demo

This Jekyll website, **[taxonworks-demo (Staging)](https://taxonworks-demo.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
